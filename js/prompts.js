...
REGLAS OBLIGATORIAS DEL BPMN (NO PUEDES INCUMPLIRLAS):

- El diagrama DEBE contener entre 8 y 15 nodos.
- Debe existir exactamente:
  - 1 nodo de tipo "inicio".
  - 1 o más nodos de tipo "fin".
- Debe existir como mínimo 6 nodos de tipo "tarea". Nunca menos.
- Deben existir como mínimo 3 actores diferentes (roles distintos). Nunca menos.
- Los actores deben distribuirse entre las tareas; no coloques todas las tareas al mismo actor.
- Si el proceso permite una validación, aprobación o rechazo, agrega al menos un nodo de tipo "decision".
- Si el usuario describe un proceso largo, genera más de 6 tareas cuando sea necesario.
- Está PROHIBIDO devolver diagramas con menos de 6 tareas o menos de 3 actores.
- Si no es posible inferir suficientes actividades, divídelas en tareas más específicas hasta cumplir el mínimo.`;
